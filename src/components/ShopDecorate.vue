                    ...
                    <div  class="weui-media-box weui-media-box_appmsg" v-for="item in itemList" v-if="item.status != 2">
                        ...
                        <div class="weui-media-box__bd">
                            <h4 class="weui-media-box__title">{{item.name}}
                              <router-link href="javascript:;" :to="{name:'BuildProduct',params:{prodinfo:item}}"  class="oper">
                                <i class="ico-edit"></i>
                              </router-link>
                            </h4>
                            ...
                            <div class="weui-media-box__info"><span><em class="statu statu-dis">休息中</em></span>
                                ...
                                <a href="javascript:;" class="weui-btn weui-btn_primary weui-btn_disabled">预约</a></div>
                        </div>
                    </div>
                    <div class="add-wrap">
